...
* 1.6.0 Renamed `enabled` attribute to `disable` in line with UI Bootstrap `<tab>`.  See [#39](/../../issues/39).
...
* 1.4.0 Removed default `$state.go(..)` route option, added `enabled` option and updated jsbeautifier.  See [#16](/../../pull/16).
