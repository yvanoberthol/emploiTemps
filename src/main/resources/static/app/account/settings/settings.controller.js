(function() {
    ...
    SettingsController.$inject = ['$scope', 'auth', '$stateParams', 'JhiLanguageService', '$translate', '$http',
                                   ];

    function SettingsController ($scope, auth, $stateParams, JhiLanguageService, $translate, $http,
                                ) {
        var vm = this;
        vm.selected = 0;
